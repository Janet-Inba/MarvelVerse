...
<a href="disney.html.php">Disney+ series</a>
</div>
</div>
...
<div class="phaseimg"> 
<img class="center" src="disney.jpeg" alt="disney" style="max-width: 100%" />
</div>
<div class="phasecnt">
<p>Disney+ is an American video-on-demand streaming service owned by Walt Disney Direct-to-Consumer & International. 
On November 9, 2017, Deadline reported that Disney was developing an original Marvel television series for the service.
</p>
</div>
</div>
</div>
...
<div class="phaseimg"> 
<img class="center" src="../img/wv.png" alt="mcu" style="max-height: 225px;" />
</div>
<div class="phasecnt"><p><b>WANDA VISION (2021)</b>
<?php 
$sql1 = "SELECT ROUND(AVG(rating),2) AS average FROM ratings WHERE msname='Wanda Vision'";
...
<p>Marvel Studios' WandaVision blends the style of classic sitcoms with the Marvel Cinematic Universe in which
Wanda Maximoff and Vision – two super-powered beings living their ideal suburban life – begin to suspect that 
everything is not as it seems </p>
</div>
</div>
</div>
...
<div class="grid-container3">
<div class="phaseimg"> 
<img class="center" src="../img/faws.jpg" alt="mcu" style="max-height: 225px;" />
</div>
<div class="phasecnt"><p><b>THE FALCON AND THE WINTER SOLDIER (2021)</b>
<?php 
$sql2 = "SELECT ROUND(AVG(rating),2) AS average FROM ratings WHERE msname='The Falcon and The Winter Soldier'";
...
<p>Falcon and the Winter Soldier are a mismatched duo who team up for a global adventure that will test their survival skills -- as well as their patience.</p>
</div>
</div>
</div>
...
<div class="grid-container2">
<div class="phaseimg"> 
<img class="center" src="../img/loki.jpg" alt="mcu" style="max-height: 225px;" />
</div>
<div class="phasecnt"><p><b>LOKI (2021)</b>
<?php 
$sql3 = "SELECT ROUND(AVG(rating),2) AS average FROM ratings WHERE msname='Loki'";
...
<p>In Marvel Studios' Loki, the mercurial villain Loki resumes his role as the God of Mischief in a new series that takes place
 after the events of Avengers: Endgame.</p>
</div>
</div>
</div>
...
<div class="grid-container3">
<div class="phaseimg"> 
<img class="center" src="../img/whatif.webp" alt="mcu" style="max-height: 225px;" />
</div>
<div class="phasecnt"><p><b>WHAT IF...? (2021)</b>
<?php 
$sql4 = "SELECT ROUND(AVG(rating),2) AS average FROM ratings WHERE msname='What If...?'";
...
<p>That creative brainstorming exercise is the heart of What If...?, 
The anthology reimagines numerous major events from the movies ,
 and also features Chadwick Boseman, who was able to reprise T'Challa via voice work before his death</p>
</div>
</div>
</div>
